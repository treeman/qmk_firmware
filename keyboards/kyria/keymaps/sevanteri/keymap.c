...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_stack_wrapper( // {{{
        ...
        CTRLESC, _________________QWERTY_L2_________________,
        KC_LSFT, _________________QWERTY_L3_________________, MO(_SYMB), MO(_FUNC),
                                   KC_BTN2, MY_THL4, MY_THL3, MY_THL2, MY_THL1, 

        /******/ /******/ _________________QWERTY_R1_________________, FI_QUOT,
        /******/ /******/ _________________QWERTY_R2_________________, MY_AE,
        HOMEND,  XXXXXXX, _________________QWERTY_R3_________________, KC_RSFT,
        MY_THR1, MY_THR2, MY_THR3, MY_THR4, TD_PSCR_INS
    ), // }}}
    ...
    [_SYMB] = LAYOUT_stack_wrapper( // {{{
        _______, _________________SYMB_L1___________________,
        _______, _________________SYMB_L2___________________,
        _______, _________________SYMB_L3___________________, _______, _______,
                                   _______, _______, ___SYMB_THUMBLN_,

                          _________________SYMB_R1___________________, _______,
                          _________________SYMB_R2___________________, _______,
        _______, _______, _________________SYMB_R3___________________, _______,
        _______, _______, _______, _______, _______
    ), // }}}
